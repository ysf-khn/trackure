...
const orderFormSchema = z.object({
  ...
  required_packaging_materials: z.array(z.string()).optional().default([]), // Now an array
  ...
  if (authError) {
    return (
      <Alert variant="destructive" className="max-w-2xl mx-auto">
        ...
        <AlertDescription>
          Could not load user data: {authError.message}
        </AlertDescription>
      </Alert>
    );
  }
                      ...
                      {isMounted && !isWorkflowSelectLoading && (
                        <>
                          ...
                          {workflowResultData?.flatMap((stage) => [
                            ...
                            ...(stage.workflow_sub_stages?.map((subStage) => (
                              <SelectItem
